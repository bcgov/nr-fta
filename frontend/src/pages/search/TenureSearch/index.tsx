 ...
 * screens follow: criteria in a titled section, results in a bordered table
 * below it.
 */
const TenureSearch: FC = () => {
  ...
  return (
    <PageLayout title="Tenure Search" subtitle="Find a forest tenure by file, licensee or status">
