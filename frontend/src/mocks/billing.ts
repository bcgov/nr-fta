...
export const MOCK_AUDIT: AuditEntry[] = [
  {
    ...
    user: 'mclarke',
    action: 'UPDATE',
    entity: 'Tenure A19201',
    detail: 'AAC apportionment changed',
  },
  {
    timestamp: '2026-07-21 11:05',
    user: 'lferris',
    action: 'CREATE',
    entity: 'Cutting Permit CP-03',
    detail: 'New permit added to A19201',
  },
  {
    timestamp: '2026-07-20 16:47',
    user: 'dokafor',
    action: 'APPROVE',
    entity: 'Application ESF-100199',
    detail: 'Cutting permit issued',
  },
  {
    timestamp: '2026-07-20 09:14',
    user: 'mclarke',
    action: 'DELETE',
    entity: 'Cut Block BLK-999',
    detail: 'Draft block removed',
  },
];
