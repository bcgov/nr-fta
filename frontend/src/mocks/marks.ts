...
export const MOCK_MARKS: MarkSummary[] = [
  {
    markNumber: '12 3456',
    markType: 'Private Timber Mark',
    status: 'Active',
    holderName: 'Aspen Holdings Ltd.',
    holderClient: '00120045',
  ...
  },
  {
    ...
    markType: 'Private Timber Mark',
    status: 'Amended',
    holderName: 'Harbourview Woodlands Inc.',
    holderClient: '00098772',
  ...
  },
  {
    ...
    markType: 'Private Timber Mark',
    status: 'Cancelled',
    holderName: 'Heritage Estates Ltd.',
    holderClient: '00077120',
    orgUnit: 'DMK — Mackenzie',
    issueDate: '2011-07-19',
  },
];

const DETAIL_EXTRAS: Pick<
  MarkDetailRecord,
  'timberOrigin' | 'landIndex' | 'clients' | 'amendments'
> = {
  timberOrigin: 'Private Land — fee simple',
  landIndex: [
    {
      parcelId: 'PID-013-482-119',
      legalDescription: 'Lot 4, Plan 12345, Land District 36',
      areaHa: 42.1,
      pin: '013482119',
    },
    {
      parcelId: 'PID-013-482-127',
      legalDescription: 'Lot 5, Plan 12345, Land District 36',
      areaHa: 18.7,
      pin: '013482127',
    },
  ],
...
export function searchMarks(c: MarkSearchCriteria): MarkSummary[] {
  return MOCK_MARKS.filter((m) => {
    if (c.markNumber && !m.markNumber.toLowerCase().includes(c.markNumber.toLowerCase()))
      return false;
    if (c.holderName && !m.holderName.toLowerCase().includes(c.holderName.toLowerCase()))
      return false;
